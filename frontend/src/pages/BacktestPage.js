...
const PRESET_GROUPS = [
  {
    ...
    presets: [
      { label: 'RSI Oversold',        entry_metric: 'Ticker_RSI',             entry_condition: 'crosses_below', entry_threshold: 35,   exit_metric: 'Ticker_RSI',             exit_condition: 'crosses_above', exit_threshold: 65 },
      { label: 'RSI Deep Oversold',   entry_metric: 'Ticker_RSI',             entry_condition: 'crosses_below', entry_threshold: 25,   exit_metric: 'Ticker_RSI',             exit_condition: 'crosses_above', exit_threshold: 55 },
      { label: 'Stoch Oversold',      entry_metric: 'Ticker_Stochastic_K',    entry_condition: 'crosses_below', entry_threshold: 20,   exit_metric: 'Ticker_Stochastic_K',    exit_condition: 'crosses_above', exit_threshold: 80 },
      { label: 'Stoch Extreme',       entry_metric: 'Ticker_Stochastic_K',    entry_condition: 'crosses_below', entry_threshold: 10,   exit_metric: 'Ticker_Stochastic_K',    exit_condition: 'crosses_above', exit_threshold: 90 },
      { label: 'MFI Value Buy',       entry_metric: 'Ticker_MFI',             entry_condition: 'crosses_below', entry_threshold: 20,   exit_metric: 'Ticker_MFI',             exit_condition: 'crosses_above', exit_threshold: 70 },
      { label: 'Bollinger Bounce',    entry_metric: 'Ticker_Bollinger_PBand', entry_condition: 'crosses_below', entry_threshold: 0.1,  exit_metric: 'Ticker_Bollinger_PBand', exit_condition: 'crosses_above', exit_threshold: 0.9 },
      { label: 'Williams Oversold',   entry_metric: 'Ticker_Williams_R',      entry_condition: 'crosses_below', entry_threshold: -80,  exit_metric: 'Ticker_Williams_R',      exit_condition: 'crosses_above', exit_threshold: -20 },
    ],
  },
  {
    label: 'MOMENTUM',
    presets: [
      ...
      { label: 'MACD Above Zero',     entry_metric: 'Ticker_MACD',            entry_condition: 'crosses_above', entry_threshold: 0,    exit_metric: 'Ticker_MACD',            exit_condition: 'crosses_below', exit_threshold: 0 },
      { label: 'Tech Score Breakout', entry_metric: 'Ticker_Tech_Score',      entry_condition: 'crosses_above', entry_threshold: 60,   exit_metric: 'Ticker_Tech_Score',      exit_condition: 'crosses_below', exit_threshold: 40 },
      { label: 'Tech Score Strong',   entry_metric: 'Ticker_Tech_Score',      entry_condition: 'crosses_above', entry_threshold: 75,   exit_metric: 'Ticker_Tech_Score',      exit_condition: 'crosses_below', exit_threshold: 50 },
      { label: 'RSI Trend Follow',    entry_metric: 'Ticker_RSI',             entry_condition: 'crosses_above', entry_threshold: 55,   exit_metric: 'Ticker_RSI',             exit_condition: 'crosses_below', exit_threshold: 45 },
      { label: 'ROC Positive',        entry_metric: 'Ticker_ROC',             entry_condition: 'crosses_above', entry_threshold: 0,    exit_metric: 'Ticker_ROC',             exit_condition: 'crosses_below', exit_threshold: -2 },
      { label: 'MFI Momentum',        entry_metric: 'Ticker_MFI',             entry_condition: 'crosses_above', entry_threshold: 50,   exit_metric: 'Ticker_MFI',             exit_condition: 'crosses_below', exit_threshold: 30 },
    ],
  },
  {
    label: 'VOLATILITY',
    presets: [
      { label: 'BB Squeeze Entry',    entry_metric: 'Ticker_Bollinger_PBand', entry_condition: 'crosses_below', entry_threshold: 0.05, exit_metric: 'Ticker_Bollinger_PBand', exit_condition: 'crosses_above', exit_threshold: 0.95 },
      { label: 'BB Breakout High',    entry_metric: 'Ticker_Bollinger_PBand', entry_condition: 'crosses_above', entry_threshold: 0.95, exit_metric: 'Ticker_Bollinger_PBand', exit_condition: 'crosses_below', exit_threshold: 0.5 },
      { label: 'Low Vol Entry',       entry_metric: 'Ticker_Bollinger_WBand', entry_condition: 'crosses_below', entry_threshold: 0.05, exit_metric: 'Ticker_Bollinger_WBand', exit_condition: 'crosses_above', exit_threshold: 0.15 },
      { label: 'Vol Expansion Exit',  entry_metric: 'Ticker_Bollinger_WBand', entry_condition: 'above',         entry_threshold: 0.08, exit_metric: 'Ticker_Bollinger_WBand', exit_condition: 'crosses_above', exit_threshold: 0.25 },
    ],
  },
  {
    label: 'COMPOSITE',
    presets: [
      { label: 'RSI + Score Exit',    entry_metric: 'Ticker_RSI',             entry_condition: 'crosses_below', entry_threshold: 40,   exit_metric: 'Ticker_Tech_Score',      exit_condition: 'crosses_above', exit_threshold: 65 },
      { label: 'MACD + RSI Exit',     entry_metric: 'Ticker_MACD_Diff',       entry_condition: 'crosses_above', entry_threshold: 0,    exit_metric: 'Ticker_RSI',             exit_condition: 'crosses_above', exit_threshold: 70 },
      { label: 'Oversold Recovery',   entry_metric: 'Ticker_MFI',             entry_condition: 'crosses_below', entry_threshold: 30,   exit_metric: 'Ticker_MACD_Diff',       exit_condition: 'crosses_above', exit_threshold: 0 },
      ...
      <div className="bt-page-body">
        <div className="bt-layout">
            ...
            <div className="bt-field-group">
              ...
              <div className="bt-date-row">
                <div className="bt-date-field">
                  ...
                  <input className="bt-input bt-date-input" type="date" value={form.start_date}
                    onChange={e => { setForm(f => ({ ...f, start_date: e.target.value })); setSelectedHorizon(''); }} />
                </div>
                <div className="bt-date-field">
                  <span className="bt-date-label">TO</span>
                  <input className="bt-input bt-date-input" type="date" value={form.end_date}
                    onChange={e => { setForm(f => ({ ...f, end_date: e.target.value })); setSelectedHorizon(''); }} />
                </div>
              </div>
            </div>
          ...
          <div className="bt-results">
            ...
            {loading && (
              <div className="bt-empty">Running backtest…</div>
            )}
            {result && <>
