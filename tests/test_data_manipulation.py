...
def get_indicators_df(n=60):
    ...
    info = pd.DataFrame([{
        "Ticker": "TEST", "FullName": "Test Corp", "Sector": "Tech",
        "Subsector": "Software", "City": "NYC", "State": "NY", "Country": "US",
        "MarketCap": None, "Price": None, "52WeekHigh": None, "52WeekLow": None,
        "Exchange": None, "Currency": "USD", "QuoteType": None, "ShortName": None,
        "Website": None, "Description": None, "CEO": None, "Employees": None,
        "Zip": None, "Address": None, "Phone": None, "DividendRate": None,
        "DividendYield": None, "PayoutRatio": None, "Beta": None, "PE": None,
        "EPS": None, "Revenue": None, "GrossProfit": None, "FreeCashFlow": None,
    }])
...
def test_expected_columns_present(indicators):
    expected = [
        "Ticker_SMA_10", "Ticker_SMA_30", "Ticker_EMA_10", "Ticker_EMA_30",
        "Ticker_RSI", "Ticker_MACD", "Ticker_MACD_Signal", "Ticker_MACD_Diff",
        "Ticker_Stochastic_K", "Ticker_Stochastic_D",
        "Ticker_Bollinger_High", "Ticker_Bollinger_Low", "Ticker_Bollinger_Mid",
        "Ticker_On_Balance_Volume", "Ticker_Chaikin_MF", "Ticker_MFI",
        "Ticker_Williams_R", "Ticker_TSI", "Ticker_UO", "Ticker_ROC",
    ]
    for col in expected:
